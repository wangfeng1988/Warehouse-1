...
public class DeliveryOrderCollectDaoImp implements IDeliveryOrderCollectDao 
{
	...
	{
		System.out.println("this is add delivery collect");
	...
	public List<?> selectAll() 
	{
		...
		String queryString = "from DeliveryOrderCollect";	
	...
	private static final String LISTNAME="com.ssh.jutem.edit.model.DeliveryOrderCollect";
}
