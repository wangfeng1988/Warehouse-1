...
@Entity
public class DeliveryOrderCollect 
{
	private int id;
	private String maked_year_month;
	private double total_money;
	private Set<DeliveryOrderCollectDetail> deliverysdetail=new HashSet<DeliveryOrderCollectDetail>();
	...
	@JoinColumn(name = "deliverycollect_id")
	public Set<DeliveryOrderCollectDetail> getDeliverysdetail() {
		return deliverysdetail;
	}
	public void setDeliverysdetail(Set<DeliveryOrderCollectDetail> deliverysdetail) {
		this.deliverysdetail = deliverysdetail;
	}
