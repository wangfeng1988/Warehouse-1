...
<body class="browserscripting">
	...
	<table id="details">
		<tr>
			<td>制单日期：</td>
			<td><s:property value="requisition_detials.prepared_by_date" /></td>
			<td>单据号码：</td>
			<td><s:property value="requisition_detials.document_number" /></td>
			<td>原始单号：</td>
			<td><s:property
					value="requisition_detials.original_invoice_number" /></td>
		</tr>
		<tr>
			<td>发货仓库：</td>
			<td><s:property value="requisition_detials.shipping_warehouse" /></td>
			<td>领料单位：</td>
			<td><s:property value="requisition_detials.requisition_unit" /></td>
		</tr>
