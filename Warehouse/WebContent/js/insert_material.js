...
function insertMaterialInformation() {
	var source_table = document.getElementById("search_materialInformation");
	var goal_table = document.getElementById("material_information");
	var cheCou = document.all("box2");
