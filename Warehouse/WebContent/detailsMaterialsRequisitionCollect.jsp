...
<body class="browserscripting" >
	...
	<div class="detail_div">
		...
		<div>
			...
			<div id="table_body">
				<table id="material">
					<s:iterator value="requisitionCollect_details.requisitionsdetail" id="detail" status="index">
						<tr>
		...
		<div id="content_foot">
			...
			<form action="selectDetails_MaterialsRequisitionCollect">
				<input type="hidden" value=<s:property value="requisitionCollect_details.id"/> name="id"/>
